...
export const CLIENTS_DATA: Client[] = [
  ...
  { id: 'c-2', company: 'Solutions Co.', email: 'jane.smith@solutions.co', mobile: '555-0102', address: '456 Market St, San Francisco, CA', avatarUrl: 'https://i.pravatar.cc/150?u=a042581f4e29026705d' },
  { id: 'c-3', company: 'Tech Giants', email: 'peter.jones@techgiants.com', mobile: '555-0103', address: '789 Enterprise Way, New York, NY', avatarUrl: 'https://i.pravatar.cc/150?u=a042581f4e29026706d' },
...
export const PROJECTS_DATA: Project[] = [
  { id: 'p-1', name: 'E-commerce Platform', clientId: 'c-1', planId: 'plan-2', categoryId: 'cat-1', status: 'In Progress', budget: 50000, progress: 75, startDate: '2024-05-01', dashboardUrl: 'https://vercel.com/', currency: 'USD' },
  { id: 'p-2', name: 'Mobile Banking App', clientId: 'c-2', planId: 'plan-3', categoryId: 'cat-2', status: 'Completed', budget: 120000, progress: 100, startDate: '2023-11-15', dashboardUrl: 'https://example-dashboard.com/p2', currency: 'USD' },
  { id: 'p-3', name: 'Marketing Campaign', clientId: 'c-3', planId: 'plan-1', categoryId: 'cat-4', status: 'On Hold', budget: 15000, progress: 20, startDate: '2024-06-10', currency: 'USD' },
  { id: 'p-4', name: 'Design System', clientId: 'c-4', planId: 'plan-2', categoryId: 'cat-3', status: 'In Progress', budget: 80000, progress: 50, startDate: '2023-10-01', dashboardUrl: 'https://example-dashboard.com/p4', currency: 'USD' },
  { id: 'p-5', name: 'Internal Dashboard', clientId: 'c-1', planId: 'plan-2', categoryId: 'cat-1', status: 'Completed', budget: 35000, progress: 100, startDate: '2024-02-01', currency: 'USD' },
];
