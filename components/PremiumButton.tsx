...
const PremiumButton: React.FC<PremiumButtonProps> = ({ children, onClick, className, type = "button" }) => {
  return (
    <div className={`inline-block bg-transparent ${className || ''}`}>
      ...
      `}</style>
      <button className="shiny-cta focus:outline-none" onClick={onClick} type={type}>
