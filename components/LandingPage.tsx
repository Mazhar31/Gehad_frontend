...
const Logo: React.FC = () => (
  <div className="flex items-center space-x-2">
    ...
    >
      ...
      />
      <path
        d="M2 7L12 12M12 22V12M22 7L12 12M16 4.5L6 9.5"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
const Header: React.FC<{ onNavigate: (page: "login" | null) => void }> = ({
  onNavigate,
}) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-dark-bg/80 backdrop-blur-md border-b border-white/10">
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <button
              ...
              className="text-secondary-text font-semibold px-4 py-2 rounded-full hover:bg-white/10 transition-colors hidden md:block"
            >
              Sign In
            </button>
      ...
      {/* Mobile Menu */}
      <div
        className={`absolute top-20 left-0 w-full bg-dark-bg/95 backdrop-blur-lg md:hidden transition-all duration-300 ease-in-out transform ${
          isMobileMenuOpen
        ...
        <div className="px-4 py-6 space-y-4">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
              onClick={(e) => handleSmoothScroll(e, closeMobileMenu)}
              className="block text-center text-secondary-text hover:text-white transition-colors py-2 rounded-md"
            >
              {link.label}
            </a>
          ))}
          <div className="border-t border-border-color pt-4">
            <button
              ...
              className="w-full text-center text-white font-semibold px-4 py-2 rounded-full bg-blue-600 hover:bg-blue-700 transition-colors"
            >
              Sign In
            </button>
          </div>
...
const TestimonialCard: React.FC<{ testimonial: any }> = ({ testimonial }) => (
  <div className="bg-card-bg p-6 rounded-2xl border border-border-color text-left h-full flex flex-col">
    ...
    <blockquote className="text-secondary-text italic mb-4 flex-grow">
      "{testimonial.quote}"
    </blockquote>
...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      "OneQlek has completely transformed how we manage our client projects. The dashboard gives us a crystal-clear overview, and our clients love the transparency. Highly recommended!",
  },
  {
    name: "Michael B.",
    ...
    rating: 5,
    quote:
      "The ability to give our clients their own dashboard access is a game-changer. It's reduced our email back-and-forth by at least 50%. The platform is intuitive and powerful.",
  },
  {
    name: "Jessica L.",
    ...
    rating: 5,
    quote:
      "As a design agency, presentation is everything. OneQlek not only helps us stay organized internally but also impresses our clients with its professional and sleek interface.",
  },
];
  ...
  return (
    <div className="border-b border-border-color py-6">
      ...
      >
        ...
        <ChevronDownIcon
          className={`w-6 h-6 text-secondary-text transition-transform ${
            isOpen ? "rotate-180" : ""
          }`}
        />
      </button>
...
const LandingPage: React.FC<{ onNavigate: (page: "login" | null) => void }> = ({
  onNavigate,
}) => {
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="mt-6 text-lg text-secondary-text max-w-2xl mx-auto">
              Manage all your projects in one place with OneQlek. View plans,
              track progress, increase productivity and improve communication.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-secondary-text max-w-2xl mx-auto">
                Everything you need to streamline your workflow and keep your
                clients happy.
              </p>
            </div>
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              <FeatureCard icon={Squares2X2Icon} title="Client Dashboards">
                Impress your clients with a dedicated, professional dashboard to
                track their project's progress in real-time.
              </FeatureCard>
              <FeatureCard icon={ChartTrendingUpIcon} title="Progress Tracking">
                Visualize project milestones, budgets, and timelines with
                intuitive charts and progress bars.
              </FeatureCard>
              <FeatureCard icon={UsersIcon} title="User Management">
                Assign specific users from your client's team to projects,
                controlling their access and permissions.
              </FeatureCard>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-sidebar-bg/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-secondary-text mb-8">
              OneQlek works seamlessly with the tools you already use, making
            ...
            <div className="flex justify-center items-center flex-wrap gap-x-8 gap-y-4">
              {integrations.map((tool) => (
                <tool.icon
                  key={tool.name}
                  className="w-8 h-8 text-secondary-text hover:text-white transition-colors"
                />
              ))}
            </div>
          </div>
        ...
        <section id="portfolio" className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-4 text-lg text-secondary-text max-w-2xl mx-auto">
                We deliver high-quality solutions that solve real-world problems
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {publicPortfolio.map((caseItem, index) => (
                <div
                  key={index}
                  className="bg-card-bg rounded-2xl overflow-hidden group transition-all duration-300 hover:shadow-xl hover:shadow-blue-900/20 border border-border-color"
                >
                  ...
                  <div className="p-6">
                    ...
                    <a
                      href={caseItem.link}
                      className="inline-flex items-center font-semibold text-white group-hover:text-accent-blue transition-colors"
                    >
                      View Case Study
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-card-bg border border-border-color rounded-2xl p-8 flex flex-col items-center text-center transition-transform hover:scale-105 h-full">
                ...
                <p className="text-secondary-text text-base">
                  The price is tailored to the number of user dashboards you
                  need to deploy.
                </p>
              </div>
              <div className="bg-card-bg border border-border-color rounded-2xl p-8 flex flex-col items-center text-center transition-transform hover:scale-105 h-full">
                ...
                <p className="text-secondary-text text-base">
                  Pricing adjusts based on the total number of unique users who
                  require access.
                </p>
              </div>
              <div className="bg-card-bg border border-border-color rounded-2xl p-8 flex flex-col items-center text-center transition-transform hover:scale-105 h-full">
                ...
                <p className="text-secondary-text text-base">
                  Enhance your experience with powerful add-ins, priced
                  individually for flexibility.
                </p>
              </div>
            </div>
            <div className="mt-12">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10">
              <FaqItem question="Can I customize the client dashboards?">
                Absolutely! While the core layout is standardized for ease of
                use, you can customize branding, upload logos, and decide which
                data points and reports are visible to each client.
              </FaqItem>
              <FaqItem question="How does the 'user' pricing work?">
                You are billed based on the total number of unique users (both
                your team members and client-side users) who have active
                accounts on the platform during a billing cycle.
              </FaqItem>
              <FaqItem question="Is my data secure?">
                ...
                to ensure your and your clients' data is always protected.
              </FaqItem>
              <FaqItem question="What kind of support do you offer?">
                We offer comprehensive support through email and a dedicated
                support portal. Our team is always ready to help you with any
      ...
      <footer className="bg-dark-bg border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-8 border-t border-border-color pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-secondary-text">
            <p>
              &copy; {new Date().getFullYear()} OneQlek Inc. All rights
              reserved.
            </p>
